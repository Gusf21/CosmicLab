...
const swampTextures = import.meta.glob('../images/Textures/Swamp/*.png');
...
async function FetchFrames() {
    let newFrames = await fetch(`https://cosmiclabapi.co.uk/api/Data/GetFrames?sessionId=${GetCookie("sessionId").replace(/['"]+/g, '').toUpperCase()}&timescale=3600&num=2000`);

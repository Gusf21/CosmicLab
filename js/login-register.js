...
async function Register(e) {
    ...
    const response = await fetch("https://cosmiclabapi.co.uk:2030/api/LoginDetails/AddUser", {
        method: "POST",
        headers: {
...
async function CheckLogin(e) {
    ...
    const response = await fetch("https://cosmiclabapi.co.uk:2030/api/LoginDetails/CheckLoginDetails", {
        method: "POST",
        "headers": {
            "Content-Type": "application/json",
        },
